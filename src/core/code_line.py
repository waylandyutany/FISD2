...
class Code_line:
    ...
    @classmethod
    def split_code_line(cls, code_line):
    ...
    @classmethod
    def add_code_line_label(cls, code_line, label_name):
    ...
    @classmethod
    def add_code_line_jump(cls, code_line, jump_name, label_name):
    ...
    @classmethod
    def get_code_line_jump(cls, code_line, jump_name):
        if Code_line._CODE_JUMPS not in code_line:
            return None
    ...
    @classmethod
    def get_code_line_labels(cls, code_line):
        if Code_line._CODE_LABEL in code_line:
            return code_line[Code_line._CODE_LABEL]
        return []

    @classmethod
    def get_code_line_jumps(cls, code_line):
        if Code_line._CODE_JUMPS not in code_line:
            return {}
