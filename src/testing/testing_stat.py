...
################################################################################
    def enumerate(self, testing_stat_enumerator):
        has_attr_on_test_suite = hasattr(testing_stat_enumerator,'on_test_suite')
        has_attr_on_test_set = hasattr(testing_stat_enumerator,'on_test_set')
        has_attr_on_test_case = hasattr(testing_stat_enumerator,'on_test_case')

        test_suites = self.__stat[TestingStat._key_test_suites]
        for suite_name in test_suites:
            if has_attr_on_test_suite:
